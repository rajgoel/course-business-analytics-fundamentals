...
The enterpreneur cannot sell the commodity in the same period in which he buys it. Assuming that $p_i$, $w_i$, and $s_i$ denote the purchase cost, inventory carrying cost, and selling price per unit in period $i$, what buy-sell policy should the enterpreneur adopt to maximize total profit in the $T$ periods? 
